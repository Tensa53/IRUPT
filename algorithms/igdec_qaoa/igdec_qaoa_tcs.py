...
def plot(fval_list, reps, file_name, problem_size):
    plt.plot(fval_list)
    plt.ylabel('fval')
    plt.savefig("../../results/igdec_qaoa/tcs/ideal/qaoa_"+str(reps)+"/" + file_name + "/" + test_tool  + "/size_" + str(problem_size) + "/" + str(num_experiment)+"/fval_trend.png")
...
if __name__ == '__main__':
    ...
    for file_name in programs:
        ...
        if not os.path.exists("../../results/igdec_qaoa/tcs/ideal/qaoa_"+str(reps)+"/" + file_name + "/" + test_tool + "/size_" + str(problem_size) + "/" + str(num_experiment)):
            os.makedirs("../../results/igdec_qaoa/tcs/ideal/qaoa_"+str(reps)+"/" + file_name + "/" + test_tool  + "/size_" + str(problem_size) + "/" + str(num_experiment))
        log_df.to_csv("../../results/igdec_qaoa/tcs/ideal/qaoa_"+str(reps)+"/" + file_name + "/" + test_tool + "/size_" + str(problem_size) + "/" + str(num_experiment)+"/log.csv")

        if not os.path.exists("../../results/igdec_qaoa/tcs/ideal/qaoa_"+str(reps)+"/" + file_name + "/" + test_tool + "/size_" + str(problem_size) + "/" + str(num_experiment)):
            os.makedirs("../../results/igdec_qaoa/tcs/ideal/qaoa_"+str(reps)+"/" + file_name + "/" + test_tool + "/" + test_tool + "/size_" + str(problem_size) + "/" + str(num_experiment))
        result_df.to_csv("../../results/igdec_qaoa/tcs/ideal/qaoa_"+str(reps)+"/" + file_name + "/" + test_tool + "/size_" + str(problem_size) + "/" + str(num_experiment)+"/itr_results.csv")

        if not os.path.exists("../../results/igdec_qaoa/tcs/ideal/qaoa_"+str(reps)+"/" + file_name + "/" + test_tool + "/size_" + str(problem_size) + "/" + str(num_experiment)):
            os.makedirs("../../results/igdec_qaoa/tcs/ideal/qaoa_"+str(reps)+"/" + file_name + "/" + test_tool + "/size_" + str(problem_size) + "/" + str(num_experiment))
        solution_df.to_csv("../../results/igdec_qaoa/tcs/ideal/qaoa_"+str(reps)+"/" + file_name + "/" + test_tool + "/size_" + str(problem_size) + "/" + str(num_experiment)+"/solution.csv")

        json.dump(unique_pareto_fronts, open("../../results/igdec_qaoa/tcs/ideal/qaoa_"+str(reps)+"/" + file_name + "/" + test_tool + "/size_" + str(problem_size) + "/" + str(num_experiment)+"/pareto_fronts.json", "w"))
